...
SELECT L.ID_LIVRO, L.TITULO, L.AUTOR, L.ANO_PUBLICACAO, E.ID_EDITORA, E.NOME_EDITORA, E.PAIS
FROM LIVRO L
INNER JOIN EDITORA E ON E.ID_EDITORA = L.ID_LIVRO
ORDER BY E.NOME_EDITORA;
--8. Mostre empréstimos com título do livro e autor.
SELECT EM.ID_EMPRESTIMO, EM.DATA_EMPRESTIMO, EM.DATA_DEVOLUCAO, EM.MULTA, L.TITULO, L.AUTOR, L.ANO_PUBLICACAO
FROM EMPRESTIMO EM
...
SELECT L.ID_LIVRO, L.TITULO, L.AUTOR, L.ANO_PUBLICACAO, L.GENERO, L.PRECO, E.NOME_EDITORA
FROM LIVRO L
INNER JOIN EDITORA E ON E.ID_EDITORA = L.ID_EDITORA WHERE E.PAIS LIKE 'Brasil';
