...
ALTER TABLE VOO
ADD CONSTRAINT FK_CONEXAO FOREIGN KEY (CONEXAO) REFERENCES VOO (IDVOO);

CREATE TABLE PASSAGEIRO_VOO(
PASSAGEIRO int NOT NULL,
VOO int NOT NULL,
ASSENTO varchar(3) NOT NULL,
PRIMARY KEY (PASSAGEIRO, VOO, ASSENTO),
FOREIGN KEY (PASSAGEIRO) REFERENCES PASSAGEIRO (IDPASSAGEIRO),
FOREIGN KEY (VOO) REFERENCES VOO (IDVOO)
);
