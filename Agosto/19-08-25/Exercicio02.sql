...
RG_RESPONSAVEL varchar(10) NOT NULL,
NOME_DEPENDENTE varchar(100) PRIMARY KEY NOT NULL,
DT_NASCIMENTO date,
RELACAO varchar(20),
SEXO varchar(10),
CONSTRAINT PK_DEPENDENTES PRIMARY KEY (RG_RESPONSAVEL, NOME_DEPENDENTE),
...
CONSTRAINT FK_DEPTO_PROJETO_NUM_DEPTO FOREIGN KEY (NUM_DEPTO)
REFERENCES DEPARTAMENTO(NUM_DEPTO),
CONSTRAINT FK_DEPTO_PROJETO_NUM_PROJETO FOREIGN KEY (NUM_PROJETO)
...
NUM_PROJETO int NOT NULL,
CONSTRAINT FK_EMPREGADO_PROJETO_RG_EMPREGADO FOREIGN KEY (RG_EMPREGADO)
REFERENCES EMPREGADO(RG),
CONSTRAINT FK_EMPREGADO_PROJETO_NUM_PROJETO FOREIGN KEY (NUM_PROJETO)
REFERENCES PROJETO(NUM_PROJETO),
HORAS varchar(5)
);
