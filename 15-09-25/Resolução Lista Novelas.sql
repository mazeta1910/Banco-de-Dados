...
FROM ATOR A
LEFT JOIN PERSONAGEM P ON P.CODIGO_ATOR = A.CODIGO_ATOR
...
FROM ATOR A
LEFT JOIN Personagem P ON A.CODIGO_ATOR = P.CODIGO_ATOR
LEFT JOIN NovelaPersonagem NP ON P.CODIGO_PERSONAGEM = NP.CODIGO_PERSONAGEM
LEFT JOIN Novela N ON N.CODIGO_NOVELA = NP.CODIGO_NOVELA
...
FROM ATOR A
LEFT JOIN Personagem P ON P.CODIGO_ATOR = A.CODIGO_ATOR
LEFT JOIN NovelaPersonagem NP ON NP.CODIGO_PERSONAGEM = P.CODIGO_PERSONAGEM
...
-- 26) Selecione o nome dos atores que trabalharam nas mesmas novelas que a atriz "Joaquina Penteado"
SELECT NOME_ATOR
FROM ATOR
WHERE CODIGO_ATOR FROM 
